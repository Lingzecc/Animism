...
document.addEventListener('DOMContentLoaded', function() {
	...
	mq.addListener(function(e) {
		if (e.matches) {
			themeStylesheet.href = 'assets/css/style_from_phone.css';
		} else {
			themeStylesheet.href = 'assets/css/style_from_computer.css';
		}
	});
	mq.matches ? themeStylesheet.href = 'assets/css/style_from_phone.css' : themeStylesheet.href =
		'assets/css/style_from_computer.css';
});
...
function toggleButton() {  
    ...
    if (button.classList.contains('expanded')) {  
        recorderImg.src = "assets/img/record_on.png";  
        console.log('Image changed to record_on.png');  
    } else {  
        recorderImg.src = "assets/img/record_off.png";  
